...
add_action('admin_enqueue_scripts', 'nitupload_scripts');


class nextImageWidget extends unWidget
{

    function nextImageWidget()
    {
        $widget_ops = array('classname' => 'nextImageWidget', 'description' => '' );
        $this->WP_Widget('nextImageWidget', 'Next Image Teaser', $widget_ops);
    }
    ...
    function widget($args, $instance)
    {
        ...
        $twig=initTwig();
        $template = $twig->loadTemplate('widget_image.html');
